...
describe('Story Generation API Tests', () => {
    before(() => {
    ...
    environments().forEach((env) => {
        describe(`${env.toUpperCase()} Environment`, () => {
            ...
            context('Positive Test Cases @positive', () => {
                it('should successfully generate story with valid input', () => {
                    const apiUrl = `${config.baseUrl}/v2/business/content/story-generation`;
                ...
                it('should validate response time is within acceptable range', () => {
                    makeRequest({
                        method: 'POST',
                        url: `${config.baseUrl}/v2/business/content/story-generation`,
                        headers,
                        queryParams,
                        body: defaultPayload,
                        failOnStatusCode: false
