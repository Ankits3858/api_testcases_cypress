...
describe('Landing Page Headlines API Tests', () => {
    before(() => {
    ...
    environments().forEach((env) => {
        describe(`${env.toUpperCase()} Environment`, () => {
            ...
            context('Positive Test Cases @positive', () => {
                it('should successfully generate landing page headlines with valid input', () => {
                    const apiUrl = `${config.baseUrl}/v2/business/content/landing-page-headlines`;
                ...
                it('should validate response time is within acceptable range', () => {
                    makeRequest({
                        method: 'POST',
                        url: `${config.baseUrl}/v2/business/content/landing-page-headlines`,
                        headers,
                        queryParams,
                        body: defaultPayload,
                        failOnStatusCode: false
