...
describe('Startup Ideas API Tests', () => {
    before(() => {
    ...
    environments().forEach((env) => {
        describe(`${env.toUpperCase()} Environment`, () => {
            ...
            context('Positive Test Cases @positive', () => {
                it('should successfully generate startup ideas with valid input', () => {
                    const apiUrl = `${config.baseUrl}/v2/business/content/startup-ideas`;
                ...
                it('should validate response time is within acceptable range', () => {
                    makeRequest({
                        method: 'POST',
                        url: `${config.baseUrl}/v2/business/content/startup-ideas`,
                        headers,
                        queryParams,
                        body: {},
                        failOnStatusCode: false
