...
describe('Make Your Own AI API Tests', () => {
    before(() => {
    ...
    environments().forEach((env) => {
        describe(`${env.toUpperCase()} Environment`, () => {
            ...
            context('Positive Test Cases @positive', () => {
                it('should successfully generate content with valid input', () => {
                    const apiUrl = `${config.baseUrl}/v2/business/content/command`;
                ...
                it('should validate response time is within acceptable range', () => {
                    makeRequest({
                        method: 'POST',
                        url: `${config.baseUrl}/v2/business/content/command`,
                        headers,
                        queryParams,
                        body: defaultPayload,
                        failOnStatusCode: false
            ...
            context('Negative Test Cases @negative', () => {
                it('should handle empty instruction field', () => {
                    makeRequest({
                        method: 'POST',
                        url: `${config.baseUrl}/v2/business/content/command`,
                        headers,
                        queryParams,
                        body: { ...defaultPayload, instruction: "" },
                        failOnStatusCode: false
                    }).then((response) => {
