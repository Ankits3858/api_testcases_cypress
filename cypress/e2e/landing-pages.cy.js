...
describe('Landing Pages API Tests', () => {
    before(() => {
    ...
    environments().forEach((env) => {
        describe(`${env.toUpperCase()} Environment`, () => {
            ...
            context('Positive Test Cases @positive', () => {
                it('should successfully generate landing page with valid input', () => {
                    const apiUrl = `${config.baseUrl}/v2/business/content/landing-pages`;
                ...
                it('should validate response time is within acceptable range', () => {
                    makeRequest({
                        method: 'POST',
                        url: `${config.baseUrl}/v2/business/content/landing-pages`,
                        headers,
                        queryParams,
                        body: defaultPayload,
                        failOnStatusCode: false
            ...
            context('Negative Test Cases @negative', () => {
                ...
                it('should handle empty feature_1 field', () => {
                    makeRequest({
                        method: 'POST',
                        url: `${config.baseUrl}/v2/business/content/landing-pages`,
                        headers,
                        queryParams,
                        body: { ...defaultPayload, feature_1: "" },
                        failOnStatusCode: false
                    }).then((response) => {
                        expect(response.status).to.eq(400);
                    });
                ...
                it('should handle empty feature_2 field', () => {
                    makeRequest({
                        method: 'POST',
                        url: `${config.baseUrl}/v2/business/content/landing-pages`,
                        headers,
                        queryParams,
                        body: { ...defaultPayload, feature_2: "" },
                        failOnStatusCode: false
                    }).then((response) => {
                        expect(response.status).to.eq(400);
                    });
                ...
                it('should handle empty feature_3 field', () => {
                    makeRequest({
                        method: 'POST',
                        url: `${config.baseUrl}/v2/business/content/landing-pages`,
                        headers,
                        queryParams,
                        body: { ...defaultPayload, feature_3: "" },
                        failOnStatusCode: false
                    }).then((response) => {
                        expect(response.status).to.eq(400);
                    });
