...
describe('Content Shorten API Tests', () => {
    before(() => {
    ...
    environments().forEach((env) => {
        describe(`${env.toUpperCase()} Environment`, () => {
            ...
            context('Positive Test Cases @positive', () => {
                it('should successfully shorten content with valid input', () => {
                    const apiUrl = `${config.baseUrl}/v2/business/content/content-shorten`;
                ...
                it('should validate response time is within acceptable range', () => {
                    makeRequest({
                        method: 'POST',
                        url: `${config.baseUrl}/v2/business/content/content-shorten`,
                        headers,
                        queryParams,
                        body: defaultPayload,
                        failOnStatusCode: false
            ...
            context('Negative Test Cases @negative', () => {
                it('should handle empty content_to_shorten field', () => {
                    makeRequest({
                        method: 'POST',
                        url: `${config.baseUrl}/v2/business/content/content-shorten`,
                        headers,
                        queryParams,
                        body: { ...defaultPayload, content_to_shorten: "" },
                        failOnStatusCode: false
                    }).then((response) => {
