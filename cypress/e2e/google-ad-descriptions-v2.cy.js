...
describe('Google Ad Descriptions V2 API Tests', () => {
    before(() => {
        ...
        describe(`${env.toUpperCase()} Environment`, () => {
            ...
            context('Positive Test Cases @positive', () => {
                it('should successfully generate google ad description with valid input', () => {
                    const apiUrl = `${config.baseUrl}/v2/business/content/google-ad-descriptions-v2`;
                ...
                it('should validate response time is within acceptable range', () => {
                    makeRequest({
                        method: 'POST',
                        url: `${config.baseUrl}/v2/business/content/google-ad-descriptions-v2`,
                        headers,
                        queryParams,
                        body: defaultPayload,
                        failOnStatusCode: false
            ...
            context('Negative Test Cases @negative', () => {
                ...
                it('should handle empty details field', () => {
                    makeRequest({
                        method: 'POST',
                        url: `${config.baseUrl}/v2/business/content/google-ad-descriptions-v2`,
                        headers,
                        queryParams,
                        body: { ...defaultPayload, details: "" },
                        failOnStatusCode: false
                    }).then((response) => {
                        expect(response.status).to.eq(400);
                    });
