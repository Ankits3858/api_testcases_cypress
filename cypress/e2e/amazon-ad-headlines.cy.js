...
describe('Amazon Sponsored Brand Ads Headlines API Tests', () => {
    before(() => {
    ...
    environments().forEach((env) => {
        describe(`${env.toUpperCase()} Environment`, () => {
            ...
            context('Positive Test Cases @positive', () => {
                it('should successfully generate ad headlines with valid input', () => {
                    const apiUrl = `${config.baseUrl}/v2/business/content/amazon-ad-headlines`;
                ...
                it('should validate response time is within acceptable range', () => {
                    makeRequest({
                        method: 'POST',
                        url: `${config.baseUrl}/v2/business/content/amazon-ad-headlines`,
                        headers,
                        queryParams,
                        body: defaultPayload,
                        failOnStatusCode: false
