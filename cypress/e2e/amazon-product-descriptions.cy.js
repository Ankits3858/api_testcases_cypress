...
describe('Amazon Product Descriptions API Tests', () => {
    before(() => {
    ...
    environments().forEach((env) => {
        describe(`${env.toUpperCase()} Environment`, () => {
            ...
            context('Positive Test Cases @positive', () => {
                it('should successfully generate product description with valid input', () => {
                    const apiUrl = `${config.baseUrl}/v2/business/content/amazon-product-descriptions`;
                ...
                it('should validate response time is within acceptable range', () => {
                    makeRequest({
                        method: 'POST',
                        url: `${config.baseUrl}/v2/business/content/amazon-product-descriptions`,
                        headers,
                        queryParams,
                        body: defaultPayload,
                        failOnStatusCode: false
