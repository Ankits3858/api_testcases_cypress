...
describe('Listicle Ideas API Tests', () => {
    before(() => {
    ...
    environments().forEach((env) => {
        describe(`${env.toUpperCase()} Environment`, () => {
            ...
            context('Positive Test Cases @positive', () => {
                it('should successfully generate listicle ideas with valid input', () => {
                    const apiUrl = `${config.baseUrl}/v2/business/content/listicle-ideas`;
                ...
                it('should validate response time is within acceptable range', () => {
                    makeRequest({
                        method: 'POST',
                        url: `${config.baseUrl}/v2/business/content/listicle-ideas`,
                        headers,
                        queryParams,
                        body: defaultPayload,
                        failOnStatusCode: false
