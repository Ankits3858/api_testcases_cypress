...
describe('Instant Article Writer API Tests', () => {
    before(() => {
        ...
        describe(`${env.toUpperCase()} Environment`, () => {
            ...
            context('Positive Test Cases @positive', () => {
                it('should successfully generate article with valid input', () => {
                    const apiUrl = `${config.baseUrl}/v2/business/content/instant-article-writer`;
                ...
                it('should validate response time is within acceptable range', () => {
                    makeRequest({
                        method: 'POST',
                        url: `${config.baseUrl}/v2/business/content/instant-article-writer`,
                        headers,
                        queryParams,
                        body: defaultPayload,
                        failOnStatusCode: false
            ...
            context('Negative Test Cases @negative', () => {
                it('should handle empty article_title field', () => {
                    makeRequest({
                        method: 'POST',
                        url: `${config.baseUrl}/v2/business/content/instant-article-writer`,
                        headers,
                        queryParams,
                        body: { ...defaultPayload, article_title: "" },
                        failOnStatusCode: false
                    }).then((response) => {
